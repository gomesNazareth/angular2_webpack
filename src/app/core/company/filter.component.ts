...
export class FilterComponent implements OnInit {
    ...
    @Input() page:string= "/companies/all";
    ...
    public constructor(public _loadservice: LoaderService,
    ...
    public onApply() {
        ...
        // this._router.navigate([this.page],{queryParams:{ locations:this.elementList["locations"].elementsChecked,
        //     cities: this.elementList["cities"].elementsChecked,
        //     sectors: this.elementList["sectors"].elementsChecked,
        //     companies: this.elementList["companies"].elementsChecked
        // }});
