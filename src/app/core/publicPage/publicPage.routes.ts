...
export const PublicPageRoutes: Array<any> = [
  ...
  // { path: 'signup_jobseeker', loadChildren: './app/core/publicPage/signupjobseeker.module#SignupJobseekerModule', canActivate: [CanHomeActivateGuard] },
  // { path: 'signup_employer',loadChildren: './app/core/publicPage/signupemployer.module#SignupEmployerModule', canActivate: [CanHomeActivateGuard] },
