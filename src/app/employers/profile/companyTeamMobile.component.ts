...
@Component({
    ...
    selector: "company-team-mobile",
    templateUrl: "companyTeamMobile.component.html"

})


export class CompanyTeamMobileComponent implements OnInit {
    ...
    editTeamMember(id = null,index =null){
        ...
        this.companyTeamObs.subscribe(res => {
            ...
            this.file_team = new File("Upload your Profile Image","profile", "PNG, JPG", 3, 'MB');
            this.file_team.classMap = "myteamprofile";
            this.file_team.mode = "profile_member";
            this.file_team.selId = (index == null)?null:res[index]["id"];
            this.file_team.root = "company_member[avatar]";
            this.file_team.method = "PUT";
    ...
    onBuildFileList() {
        this.companyTeamObs.subscribe(res=>{
            ...
            res.forEach((selteam,teamIndex)=>{
                ...
                this.fileTeamList[teamIndex] = new File("Upload your Profile Image","profile", "PNG, JPG", 3, 'MB');
                this.fileTeamList[teamIndex].classMap = "myteamprofile_mob"+teamIndex;
        ...
        this.file_team = new File("Upload your Profile Image","profile", "PNG, JPG", 3, 'MB');
        this.file_team.classMap = "myteamprofile_mob";
        this.file_team.mode = "profile_member";
