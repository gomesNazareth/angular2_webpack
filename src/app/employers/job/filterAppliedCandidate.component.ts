...
export class FilterAppliedCandidateComponent implements OnInit {
    ...
    public expRangeList =[{id:1,name:"0 - 1 years"},{id:2,name:"2 - 3 years"},{id:3,name:"3 - 4 years"}];
    public id;


    @Input() page:string= "/jobs/applicants";
    ...
    public _getFetchData() {
        ...
        //     this.expRangeList.forEach(selval=>{
        //         let selElement = new Sector();
    ...
    public onResetUrl(){
        ...
        this.paramsList = {};
        if(this.orderBy)
            this._router.navigate([this.page],{"queryParams":{id:this.id,order:this.orderBy}});
        else
    ...
    public getLoadData(){
        ...
        this.params$ = this._activeRoute.params.subscribe(params => {
            ...
            this.queryParams$ = this._activeRoute.queryParams.subscribe(qparams => {
                ...
                if((qparams["order"] && this.orderBy == null) || ((!qparams["order"]) && this.orderBy != null)){
                ...
                this.filters.forEach(selfilter => {
                    ...
                    this.elementList[selfilter].elementsChecked = this._getBuildParamsUrl(qparams[this.paramsHash[selfilter]],selfilter);
